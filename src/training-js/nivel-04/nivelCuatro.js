...
// console.log(crearGato("gary", 6).meow());
...
// console.log(invocarMetodo({}, "hello").hello());
...
function eliminarPropiedad(objeto, unaPropiedad) {
  ...
  objeto[unaPropiedad] = unaPropiedad;

  delete objeto[unaPropiedad];
  return objeto;
}

// console.log(eliminarPropiedad({}, "Hey"));
...
// console.log("Mauricio", "martinez", "123asd");
...
// console.log(tieneEmail({"email": "asd"}));
...
console.log(agregarMetodoCalculoDescuento({}).calcularPrecioDescuento())
